#!/usr/bin/env bash
# CEXI Model Viewer - DEV / watch mode. Unix counterpart of Start.bat.
...
# `CEXI_GAME_DIR=... ./start.sh` still overrides the file.
load_env_file() {
...
echo
echo "Starting CEXI Model Viewer in dev mode - hot reload enabled."
