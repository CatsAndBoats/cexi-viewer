    ...
    <div className="modal-backdrop" onPointerDown={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal help-modal" ref={panelRef} style={style}>
        ...
        <div className="modal-body help-body">
          <img className="help-logo" src="./cexi.png" alt="CEXI" width={140} draggable={false} />
          <div className="help-title">CEXI Model Viewer</div>
          ...
          <div className="help-links">
            <a className="help-link" href={GITHUB} onClick={(e) => openLink(e, GITHUB)}>
              ...
              <span>GitHub — CatsAndBoats/model-viewer</span>
            </a>
            <a className="help-link" href={DISCORD} onClick={(e) => openLink(e, DISCORD)}>
              <span className="icon">forum</span>
              <span>Support — CatsEyeXI Discord</span>
            </a>
          </div>
        </div>
