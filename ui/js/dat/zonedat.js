...
//
// Ports of cexi-tools cexi/event/xi_event.py and cexi/dialog/xi_dialog.py
...
// cval < 0x20 → [code, paramBytes] (codes: see CODE_NAMES in cexi _sjis_data).
const LOW_SPECIAL = {
