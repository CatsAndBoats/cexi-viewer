...
// CEXI_* vars; the '' prefix opts the unprefixed names into loadEnv. process.env
// wins so `CEXI_FS_PROXY=... npm run dev` still overrides the file.
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        // CEXI_FS_PROXY repoints it (remote dev box, alternate port).
        '/fs': env.CEXI_FS_PROXY || 'http://127.0.0.1:8766',
      },
    },
  };
});
