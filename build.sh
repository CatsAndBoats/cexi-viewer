#!/usr/bin/env bash
# CEXI Model Viewer - production build (embeds the Vite frontend into the binary).
...
# `CEXI_GAME_DIR=... ./build.sh` still overrides the file.
load_env_file() {
...
echo
echo "Building CEXI Model Viewer release (Vite + Tauri)..."
echo
